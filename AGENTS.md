...
1. `~/Projekte/AGENTS.md`
2. `~/Projekte/ide-llm-cross-coding/.ide-llm-cross-coding.md`
3. `~/Projekte/ide-llm-cross-coding/briefings/BRIEFING-GLOBAL-IDE-LLM-CROSS-CODING-2026-05-06.md`
4. Projektlokale `CLAUDE.md`, `HANDOFF.md`, `TESTING.md`, `RECOVERY.md`, `briefings/` und Registry-Hinweise, wenn vorhanden.

Dieses Repo ist nicht die SSoT für globale Agentenregeln. Globale Agentenregeln liegen neutral in `~/Projekte/ide-llm-cross-coding`.
