# 023: Gates & Review (Konzept-Gate · Launch-Gate · Pentest · Re-Review)
...
- DSGVO: Tracker-Inventar, externe Hosts, Consent-Banner, Datenschutzerklärung, AVV-Status (→ Standard 033)
- Bei Black-Box-Anteil > 20 %: zusätzlich `/code-review ultra` durchlaufen
- Lockfile committed; `npm audit` ohne Critical/High; Standards 025 + 018 PASS
...
**Re-Review-Umfang:** Audit-Lauf PASS; Section J LAUNCH-REVIEW.md; neue Tracker/Drittdienste (→ Standard 012); Bundle-Drift-Check (→ Standard 012); DNS/Cert-Check; Pentest-Light; neuer Sign-Off-Block.
