# 024: Stack & Platform Policy (Whitelist · Self-Hosted-First)
...
- PII-verarbeitende externe Dienste: AVV-Status prüfen (→ Standard 033)
...
damit zerfällt Abschnitt D von Standard 025, der genau eine verlangt. venfree ist der
...
@theme {
  /* Semantische Token zeigen auf CSS-Custom-Properties, nie auf eigene Strings.
     Die Zweistufigkeit verlangt Standard 025 D. */
